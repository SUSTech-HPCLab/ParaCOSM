...
# QUERY_GRAPH=${DIR}/${DATA_SET}/query_graph/sparse_6/Q_46
QUERY_GRAPH=/home/cc/haibin2/livejournal/30/query_graph/sparse_6/Q_big7
...
sudo ./build/csm -a ${ALGORITHM} -d ${DATA_GRAPH} -u ${INSERT_GRAPH} \
        -q ${FINAL} --time-limit ${TIME_LIMIT} --report-initial off -t 32 --auto-tuning 0

# sudo ./build/csm -a parallel_turboflux -d ${DATA_GRAPH} -u ${INSERT_GRAPH} \
#         -q ${FINAL} --time-limit ${TIME_LIMIT} --report-initial off -t 6
