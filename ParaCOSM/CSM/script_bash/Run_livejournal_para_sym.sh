...
OUTPUT_DIR=logs_txt/livejournal/symbi_dense

# Time limit (in seconds)
TIME_LIMIT=180

# Graph files
DATA_GRAPH=/home/cc/haibin2/livejournal/data_graph/data.graph
INSERT_GRAPH=/home/cc/haibin2/livejournal/data_graph/insertion.graph
...
for SUFFIX in "${SUFFIXES[@]}"; do
    ...
    # Output file
    OUTPUT=${ALGORITHM}_Symbi_${SUFFIX}_P2.txt

    # Define configurations for sparse, dense, tree
    CONFIGS=(
        # "sparse ${DIR}/livejournal/random_walk/${SUFFIX}_self/sparse"
        "dense ${DIR}/livejournal/random_walk/${SUFFIX}_self/dense"
        # "tree ${DIR}/livejournal/random_walk/${SUFFIX}_self/tree"
    )
